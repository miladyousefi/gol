...
/** 
 * \brief rend non viable (pas de vie) la cellule (i,j) de la grille g
 * \param i indice de ligne de la cellule
 * \param j indice de colonne de la cellule
 * \param g grille
 * \pre i < g.nbl
...
/** 
 * \brief teste si la cellule (i,j) de la grille g est nonviable
 * \param i indice de ligne de la cellule
 * \param j indice de colonne de la cellule
 * \param g grille
 * \return entier (booléen) vaut 1 si la cellule est nonviable, 0 sinon
 * \pre i < g.nbl
 * \pre j < g.nbc
 */
